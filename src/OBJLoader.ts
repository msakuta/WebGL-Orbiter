...
class MaterialState implements IMaterialState {
    index: number;
    name: string;
    mtllib?: Array<string>;
    smooth: boolean;
    ...
    constructor(params: IMaterialState){
        this.index = params.index;
        this.name = params.name;
        this.mtllib = params.mtllib;
        this.smooth = params.smooth;
        this.groupStart = params.groupStart;
        this.groupEnd = params.groupEnd;
        this.groupCount = params.groupCount;
        this.inherited = params.inherited;
    }
...
class ObjectState {
    ...
    startMaterial( name: string, libraries: any ) {
        ...
        var material = new MaterialState({
    ...
    _finalize( end: boolean ) {
        ...
        if ( end && this.materials.length === 0 ) {
            ...
            this.materials.push( new MaterialState({
                name: '',
                smooth: this.smooth
            }) );
        ...
        if ( hasPrimitives === true ) {
            ...
            for ( var i = 0, l = state.objects.length; i < l; i ++ ) {
                ...
                for ( var mi = 0, miLen = materials.length; mi < miLen; mi ++ ) {
                    ...
                    let material = state.materials.get( materialHash );
                    ...
                    if ( this.materials !== null ) {
                        ...
                        if ( isLine && material && ! ( material instanceof LineBasicMaterial ) ) {
                            ...
                            // materialLine.color.copy( material.color ); // color property seems to be removed from Material
                            ...
                            // materialPoints.color.copy( material.color ); // color property seems to be removed from Material
                    ...
                    if ( material === undefined ) {
                        ...
                        state.materials.set( materialHash, material );
